...
namespace udemy
{
    ...
    public class ItemDropper : MonoBehaviour, ISaveable
    {
        ...
        /// is stackable.
        /// </param>
        public void DropItem(InventoryData item, int number)
        {
        ...
        /// </summary>
        /// <param name="item">The item type for the pickup.</param>
        public void DropItem(InventoryData item)
        {
        ...
        public void SpawnPickup(InventoryData item, Vector3 spawnLocation, int number)
        {
